...
class Simulate{
    ...
    public:
        Simulate(){
            ...
            setCells();
            setBoard();
            cout<<"This is Mancala for statistics"<<endl;
        }
        ...
        void printStats(){
            int total=plr1Hist.size()+plr2Hist.size();
            ...
            cout<<"Total Moves Played: "<<total<<endl;
            cout<<"Recommended Moves: "<<endl;
            for(int i=1;i<=6;i++){
                cout<<"Cell "<<i<<" plays: "<<plr1Freq[i]<<endl;
            }
            cout<<"Random History: "<<endl;
            for(int i=1;i<=6;i++){
                cout<<"Cell "<<i<<" plays: "<<plr2Freq[i]<<endl;
            }
            
            if(cells[6]>cells[13]){
                cout<<"Recommended moves wins"<<endl;
            }
            else{
                cout<<"Random moves wins"<<endl;
            }
        }
